...
pub struct FieldCondition {
    ...
    pub all_mode: bool,            // |all → AND instead of OR for the list
}
...
/// Main public API — unchanged signature for full backward compatibility
...
/// Parse Field|mod1|mod2|... → field + list of modifiers (Sigma spec exact)
