...
// Grok 4.20 (4-agent) rewrite — Benjamin (safety/ReDoS/overflows), Harper (Sigma 2026 spec exact), Lucas (style/forensic audit), Grok (coord)
...
pub struct MatchDetail {
    ...
    pub triggered: BTreeMap<String, Vec<String>>, // selection → deterministic "field |mod|mod value" traces
}
