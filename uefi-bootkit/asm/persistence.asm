...
; ------------------------------------------------------------
; find_function_by_hash – rcx = hash, rdx = module base
...
; ------------------------------------------------------------
; djb2_hash – rcx = pointer to null-terminated ASCII string
...
; ------------------------------------------------------------
; resolve_apis_list – rcx = hash list pointer (dwords), rdx = module base,
...
; ------------------------------------------------------------
; find_kernel32_base – returns base in rax (0 on error)
; ------------------------------------------------------------
find_kernel32_base:
    xor eax, eax
    mov rax, gs:[0x60]        ; PEB
...
; ------------------------------------------------------------
; find_ntdll_base – returns base in rax (0 on error)
; ------------------------------------------------------------
find_ntdll_base:
    xor eax, eax
    mov rax, gs:[0x60]        ; PEB
