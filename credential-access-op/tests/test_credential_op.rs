...
// ========================================================
// STRENGT FORTROLIG â€“ TS // SIMULATION HARNESS IMPLEMENTATION â€“ FOR TRAINING USE ONLY
// NSM Directive 2026-02 | SHA-256: f3a7b4c8d2e1a9f0b5c6d3e2a1f8c9b0
// OPSEC: This code is for simulation only â€“ do not deploy operationally.
// Detection vectors: refer to threat-model.md
// Tested against: CrowdStrike Falcon v7.29+, MDE Feb 2026
// This code is validated against Simulation Harness Suite v3.1 â€“ see simulation-harness.md for test cases.
