...
impl ConfidenceCalibrator {
    fn new(ibp_verified_fraction: f64) -> Self {
        ...
        let calibration_curve = vec![
            (0.0, 0.05),   // 0% raw score → 5% confidence (floor)
            (0.5, 0.75),   // 50% raw score → 75% confidence
            (0.8, 0.95),   // 80% raw score → 95% confidence
            (0.9, 0.98),   // 90% raw score → 98% confidence
            (1.0, 0.995),  // 100% raw score → 99.5% confidence (ceiling)
        ];
